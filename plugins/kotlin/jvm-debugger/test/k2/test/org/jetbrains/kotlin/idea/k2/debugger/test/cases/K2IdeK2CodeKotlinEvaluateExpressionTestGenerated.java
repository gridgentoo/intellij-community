...
public abstract class K2IdeK2CodeKotlinEvaluateExpressionTestGenerated extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
    ...
    public abstract static class SingleBreakpoint extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
        ...
        public abstract static class Coroutines extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
            @RunWith(JUnit3RunnerWithInners.class)
            @TestMetadata("../testData/evaluation/singleBreakpoint/coroutines/runToCursor")
            public static class RunToCursor extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
                @java.lang.Override
                @org.jetbrains.annotations.NotNull
                public final KotlinPluginMode getPluginMode() {
                    return KotlinPluginMode.K2;
            ...
            public abstract static class StepInto extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
                @RunWith(JUnit3RunnerWithInners.class)
                @TestMetadata("../testData/evaluation/singleBreakpoint/coroutines/stepInto")
                public static class Uncategorized extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
                    @java.lang.Override
            ...
            public abstract static class StepOver extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
                @RunWith(JUnit3RunnerWithInners.class)
                @TestMetadata("../testData/evaluation/singleBreakpoint/coroutines/stepOver")
                public static class Uncategorized extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
                    @java.lang.Override
        ...
        public abstract static class ReflectiveAccess extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
            @RunWith(JUnit3RunnerWithInners.class)
            @TestMetadata("../testData/evaluation/singleBreakpoint/reflectiveAccess")
            public static class Uncategorized extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
                @java.lang.Override
            ...
            public static class ValueClasses extends AbstractK2IdeK2CodeKotlinEvaluateExpressionTest {
                @java.lang.Override
                @org.jetbrains.annotations.NotNull
                public final KotlinPluginMode getPluginMode() {
                    return KotlinPluginMode.K2;
