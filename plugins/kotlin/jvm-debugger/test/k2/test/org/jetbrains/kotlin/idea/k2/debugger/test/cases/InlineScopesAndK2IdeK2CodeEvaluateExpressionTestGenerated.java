...
public abstract class InlineScopesAndK2IdeK2CodeEvaluateExpressionTestGenerated extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
    ...
    public abstract static class SingleBreakpoint extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
        ...
        public abstract static class Coroutines extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
            @RunWith(JUnit3RunnerWithInners.class)
            ...
            public abstract static class StepInto extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
                @RunWith(JUnit3RunnerWithInners.class)
                @TestMetadata("../testData/evaluation/singleBreakpoint/coroutines/stepInto")
                public static class Uncategorized extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
                    @java.lang.Override
            ...
            public abstract static class StepOver extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
                @RunWith(JUnit3RunnerWithInners.class)
                @TestMetadata("../testData/evaluation/singleBreakpoint/coroutines/stepOver")
                public static class Uncategorized extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
                    @java.lang.Override
        ...
        public abstract static class ReflectiveAccess extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
            @RunWith(JUnit3RunnerWithInners.class)
            @TestMetadata("../testData/evaluation/singleBreakpoint/reflectiveAccess")
            public static class Uncategorized extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
                @java.lang.Override
